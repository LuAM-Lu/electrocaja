          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-lg ${styles.input} ${
                errores.descripcion ? 'border-red-300 bg-red-50' : ''
              }`}
              autoFocus
            />
            {errores.descripcion && (
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-3 py-2 border rounded-lg ${styles.input} ${
                  errores.precio ? 'border-red-300 bg-red-50' : ''
                }`}
              />
            </div>
            {errores.precio && (
                   ...
                   <td className="px-4 py-3 text-center">
                     {editingRowId === item.id ? (
                       ...
                       <input
                         ...
                         disabled={!isEditable}
                         className={`w-16 px-2 py-1 text-center text-sm border rounded ${styles.input} ${
